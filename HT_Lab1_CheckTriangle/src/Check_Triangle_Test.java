...
public class Check_Triangle_Test {
    @Test
    ...
    @Test
    public void kindTriangleNotATriangleTest(){
        double[] arr = {25,5,5};
        assertEquals(arr.toString()+" should be not a tri-angle", 0 ,Check_Triangle.kind_triangle(arr));

    }

    @Test
    public void kindTriangleNotATriangle2Test(){
        double[] arr = {5,25,5};
        assertEquals(arr.toString()+" should be not a tri-angle", 0 ,Check_Triangle.kind_triangle(arr));
    ...
    @Test
    public void kindTriangleNotATriangle3Test(){
        double[] arr = {5,5,25};
        assertEquals(arr.toString()+" should be not a tri-angle", 0 ,Check_Triangle.kind_triangle(arr));
