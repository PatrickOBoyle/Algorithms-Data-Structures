...
public class FacebookCirclesTest
{
  ...
  {
    FacebookCircles fbCircles = new FacebookCircles(1000);
    assertEquals( "Checking number of circles",     1000, fbCircles.numberOfCircles() );
  ...
  {
    FacebookCircles fbCircles = new FacebookCircles(100);
    fbCircles.friends(0,1);
    assertEquals( "Checking number of circles",     99, fbCircles.numberOfCircles() );
    assertEquals( "Checking size of largest circle",  2, fbCircles.sizeOfLargestCircle() );
    assertEquals( "Checking size of average circle",   1, fbCircles.sizeOfAverageCircle() );
    assertEquals( "Checking size of smallest circle", 1, fbCircles.sizeOfSmallestCircle() );

  }
  // TODO: add more simple tests for each of your methods in the FacebookCircles class
